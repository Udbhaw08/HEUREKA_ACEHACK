...
# Note: OllamaLLM is lightweight to instantiate but establishing connection happens on invoke
...
async def analyze_job_bias(payload: AnalyzeJobRequest):
    ...
    try:
        # The agent.analyze method returns a dict (we modified it to do so)
